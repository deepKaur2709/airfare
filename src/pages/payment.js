...
const Payment = () => {
    ...
    return (<div>
        ...
        {flightDetails && <div className="wrapper">
            <Card title={<div><img src={logoimagemapping[ReplaceWhiteSpaces(flightDetails.FlightName)]} className="flightLogo" alt="flightLogo" />&nbsp;&nbsp;{flightDetails.FlightName}</div>} bordered={false} extra={<div><h4>$ {bookingdetails.bookedPrice} {`(${bookingdetails.seats.length} Tickets)`}</h4></div>} className="flightDetails">
