...
const FlightBooking = (props) => {
    ...
    return (<div className="pagewrappper">
        ...
        {flightDetails && <div className="wrapper">
            <Card title={<div><img src={logoimagemapping[ReplaceWhiteSpaces(flightDetails.FlightName)]} className="flightLogo" alt="flightLogo" />&nbsp;&nbsp;{flightDetails.FlightName}</div>} bordered={false} extra={<div><h4>$ {TicketPrice} {`(${BookedSeats.length} Tickets Booked)`}</h4></div>} className="flightDetails">
